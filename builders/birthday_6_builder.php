...
foreach(glob("../sites/*/templates/*_branded.html") as $filename){
  ...
  $linkInsert = '<a href="http://stonegateemail.co.uk/$dynamic3$/website" style="color: ' . $textColor . ';text-decoration:none;"><span style="text-decoration: underline;">click here</span></a>';
